...
@interface EneterOldPin ()<OTPInputViewDelegate>
...
- (void)viewDidLoad {
    ...
    _titleLabel.text = @"Enter old PIN";
    ...
    instruction.text=@"Kindly enter your current 4-digit PIN you want to change";
