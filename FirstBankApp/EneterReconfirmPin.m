...
@implementation EneterReconfirmPin
...
- (void)viewDidLoad {
    ...
    _titleLabel.text = @"Confirm Your Pin";
    ...
    instruction.text=@"Please re-enter your new 4-digit PIN";
